...
exports.getIV = (seed) => {
    ...
    const cn = bigInt(Web3Utils.toBigInt(c).toString());
    const iv = cn.mod(F.q);
    return iv;
};
...
exports.getConstants = (seed, nRounds) => {
    ...
    for (let i=1; i<nRounds; i++) {
        ...
        const n1 = Web3Utils.toBigInt(c).mod(Web3Utils.toBigInt(F.q.toString()));
        const c2 = Web3Utils.padLeft(Web3Utils.toHex(n1), 64);
        cts[i] = bigInt(Web3Utils.toBigInt(c2).toString());
    }
    cts[0] = bigInt(0);
